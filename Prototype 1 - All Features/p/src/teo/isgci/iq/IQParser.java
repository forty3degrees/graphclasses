//=========================================================================
//
//  This file was generated by Mouse 1.6 at 2013-05-05 00:28:23 GMT
//  from grammar 'D:\K\p\src\teo\isgci\iq\iq.peg'.
//
//=========================================================================
...
public class IQParser extends mouse.runtime.ParserTest
{
  ...
  private boolean top_1()
    {
      ...
      do if (!next($Term12)) return rejectInner(top_1);
        while (!EOF());
  ...
  private boolean name()
    {
      ...
      if (!ahead('"',$Term1)) return reject(name);
      if (!next('"',$Term13)) return reject(name);
      thename();
      if (!next('"',$Term1)
       && !EOL()
         ) return reject(name);
  ...
  private boolean idchar()
    {
      ...
      if (nextIn('0','9',$Term8)) return accept(idchar);
  ...
  private boolean not()
    {
      ...
      if (!next("not",$Term5)) return reject(not);
  ...
  private boolean and()
    {
      ...
      if (!next("and",$Term4)) return reject(and);
  ...
  private boolean rparen()
    {
      ...
      if (!next(')',$Term3)) return reject(rparen);
      space();
  ...
  private boolean EOF()
    {
      ...
      if (!aheadNot($Term12)) return reject(EOF);
      return accept(EOF);
    }
  ...
  final Cache $Term4 = new Cache("\"and\"");
  final Cache $Term5 = new Cache("\"not\"");
  final Cache $Term6 = new Cache("\"<=\"");
  final Cache $Term7 = new Cache("\">=\"");
  final Cache $Term8 = new Cache("[0-9]");
