...
import teo.isgci.data.db.Disjointness;
import teo.isgci.data.db.Incomparability;
import teo.isgci.data.db.Note;
import teo.isgci.data.db.Ref;
import teo.isgci.data.gc.BaseClass;
import teo.isgci.data.gc.CliqueClass;
import teo.isgci.data.gc.ComplementClass;
import teo.isgci.data.gc.ConnectedHereditaryClass;
import teo.isgci.data.gc.ForbiddenClass;
import teo.isgci.data.gc.GraphClass;
import teo.isgci.data.gc.InducedHereditaryClass;
import teo.isgci.data.gc.IntersectClass;
import teo.isgci.data.gc.IsometricHereditaryClass;
import teo.isgci.data.gc.ProbeClass;
import teo.isgci.data.gc.UnionClass;
