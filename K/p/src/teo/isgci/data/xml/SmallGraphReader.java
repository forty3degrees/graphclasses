...
import teo.isgci.core.util.Pair;
...
public class SmallGraphReader extends DefaultHandler {
    ...
    public void startElement(String uri, String locName, String qName, 
        ...
        if (qName.equals(SmallGraphTags.SIMPLE)) {
            ...
            inclusions.add( new Pair<String, String>(
    ...
    public static void main(String args[]) throws Exception {
        ...
        Vector<HMTGrammar> grams = new Vector<HMTGrammar>();
        Vector<Family> fams = new Vector<Family>();
        Vector<Configuration> confs = new Vector<Configuration>();
