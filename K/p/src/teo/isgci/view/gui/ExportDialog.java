...
public class ExportDialog extends JDialog implements ActionListener {
    ...
    protected boolean export() {
        ...
        try {
            if (radioPS.isSelected())
                App.getDrawingService(parent).exportPS(file.getSelectedFile().toString());
            else if (radioSVG.isSelected())
            	App.getDrawingService(parent).exportSVG(file.getSelectedFile().toString());
            else if (radioGML.isSelected()) {
            	FileOutputStream f;
                try {
    ...
    protected void exportGML(FileOutputStream f) throws Exception {
        ...
        try {
            ...
            w.startDocument();
            App.getViewManager(parent).write(w);
            w.endDocument();
