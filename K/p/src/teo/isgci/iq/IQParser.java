//=========================================================================
//
//  This file was generated by Mouse 1.6 at 2013-07-13 21:21:04 GMT
//  from grammar
//    'C:\Users\TK\Documents\GitHub\graphclasses\K\p\src\teo\isgci\iq\iq.pe
//    g'.
//
//=========================================================================
...
public class IQParser extends mouse.runtime.ParserTest
{
  ...
  private boolean top_1()
    {
      ...
      do if (!next($Term4)) return rejectInner(top_1);
        while (!EOF());
  ...
  private boolean name()
    {
      ...
      if (!ahead('"',$Term19)) return reject(name);
      if (!next('"',$Term12)) return reject(name);
      thename();
      if (!next('"',$Term19)
       && !EOL()
         ) return reject(name);
  ...
  private boolean idstart()
    {
      ...
      if (nextIn('a','z',$Term11)) return accept(idstart);
  ...
  private boolean idchar()
    {
      ...
      if (next('_',$Term14)) return accept(idchar);
  ...
  private boolean not()
    {
      ...
      if (!next("not",$Term1)) return reject(not);
  ...
  private boolean and()
    {
      ...
      if (!next("and",$Term3)) return reject(and);
  ...
  private boolean rparen()
    {
      ...
      if (!next(')',$Term7)) return reject(rparen);
      space();
  ...
  private boolean EOF()
    {
      ...
      if (!aheadNot($Term4)) return reject(EOF);
      return accept(EOF);
    }
  ...
  final Cache $Term1 = new Cache("\"not\"");
  final Cache $Term2 = new Cache("[\r\n]");
  final Cache $Term3 = new Cache("\"and\"");
  final Cache $Term4 = new Cache("_");
  ...
  final Cache $Term11 = new Cache("[a-z]");
