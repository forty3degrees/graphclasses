//=========================================================================
//
//  This file was generated by Mouse 1.6 at 2013-07-12 18:19:44 GMT
//  from grammar
...
public class IQParser extends mouse.runtime.ParserTest
{
  ...
  private boolean top_1()
    {
      ...
      do if (!next($Term11)) return rejectInner(top_1);
        while (!EOF());
  ...
  private boolean idstart()
    {
      ...
      if (nextIn('A','Z',$Term6)) return accept(idstart);
  ...
  private boolean idchar()
    {
      ...
      if (next('_',$Term4)) return accept(idchar);
  ...
  private boolean or()
    {
      ...
      if (!next("or",$Term8)) return reject(or);
  ...
  private boolean and()
    {
      ...
      if (!next("and",$Term0)) return reject(and);
  ...
  private boolean lparen()
    {
      ...
      if (!next('(',$Term16)) return reject(lparen);
      space();
  ...
  private boolean rparen()
    {
      ...
      if (!next(')',$Term15)) return reject(rparen);
      space();
  ...
  private boolean EOF()
    {
      ...
      if (!aheadNot($Term11)) return reject(EOF);
      return accept(EOF);
    }
  ...
  final Cache $Term0 = new Cache("\"and\"");
  ...
  final Cache $Term6 = new Cache("[A-Z]");
  final Cache $Term7 = new Cache("\"\"\"");
  final Cache $Term8 = new Cache("\"or\"");
