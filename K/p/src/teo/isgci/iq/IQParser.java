//=========================================================================
//
//  This file was generated by Mouse 1.6 at 2013-07-10 21:33:06 GMT
//  from grammar
...
public class IQParser extends mouse.runtime.ParserTest
{
  ...
  private boolean name()
    {
      ...
      if (!ahead('"',$Term2)) return reject(name);
  ...
  private boolean idchar()
    {
      ...
      if (nextIn('0','9',$Term3)) return accept(idchar);
      if (next('_',$Term8)) return accept(idchar);
  ...
  private boolean not()
    {
      ...
      if (!next("not",$Term9)) return reject(not);
  ...
  private boolean or()
    {
      ...
      if (!next("or",$Term13)) return reject(or);
  ...
  private boolean lparen()
    {
      ...
      if (!next('(',$Term4)) return reject(lparen);
      space();
  ...
  final Cache $Term3 = new Cache("[0-9]");
